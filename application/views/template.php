...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">ADMIN Hillyu - MATERIAL DESIGN</a>
            </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                <div class="image">
                    <img src="<?=base_url()?>/assets/images/Me.JPG" width="48" height="48" alt="User" />
                </div>
                <div class="info-container">
                    <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Abiyyu Hilmi</div>
                    <div class="email">abiyyu_hilmi_26rpl@student.smktelkom-mlg.scg.id</div>
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2018 - 2019 <a href="javascript:void(0);">Material Design by Hillyu</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 15.0.0
                </div>
